...
public class Main {
    public static void main(String[] args) {
        ...
        MinTimeDelayRouteProvider rp = new MinTimeDelayRouteProvider();
        try {
